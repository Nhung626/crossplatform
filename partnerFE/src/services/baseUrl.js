...
// export const BASE_URL = "http://192.168.5.109:3000/api/v1/";
...
// export const updateCategoryUrl = BASE_URL.concat(`provider/update-room`);
...
export const getReviewUrl = BASE_URL.concat(`provider/list-reviews`);
